...
export default function PenjualLayout({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      href: "/penjual/produk-saya/tambah",
    },
    {
      name: "Produk Saya",
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <aside className="fixed left-0 top-0 h-full w-72 bg-white dark:bg-gray-900 border-r border-gray-100 dark:border-gray-800 z-50 p-6">
        ...
        <div className="absolute bottom-10 left-6 right-6 space-y-4">
          ...
          <button className="flex items-center gap-4 px-5 py-4 w-full text-red-500 font-bold hover:bg-red-50 rounded-2xl transition-all">
