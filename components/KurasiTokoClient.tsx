...
import { KurasiTokoProps } from "@/types/toko";
import { Store, Eye } from "lucide-react";
import Link from "next/link";

const KurasiTokoClient = ({ daftarToko }: KurasiTokoProps) => {
  return (
      ...
      <div className="bg-white dark:bg-gray-900 rounded-[3rem] overflow-hidden shadow-sm border border-gray-100 dark:border-gray-800">
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                ...
                >
                  ...
                  <td className="p-6">
                    <div className="flex justify-end gap-2">
                      <Link
                        href={`/admin/kurasi-toko/${toko.slug as string}`}
            ...
            {daftarToko.filter((t) => !t.isVerified).length === 0 && (
              <tr>
                <td
                  colSpan={3}
                  className="p-10 text-center text-gray-500 font-medium italic"
                >
                  Yess! Semua toko sudah terverifikasi. Tidak ada antrean baru.
                </td>
              </tr>
            )}
          </tbody>
...
export default KurasiTokoClient;
