  ...
  return (
    <div className="p-4 md:p-10 space-y-10 max-w-400 mx-auto animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="px-6 py-3 rounded-2xl border border-orange-500 dark:border-gray-800 shadow-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          <div
            key={i}
            className="group p-8 rounded-[2.5rem] border border-gray-800  hover:border-orange-500 transition-all duration-300 shadow-sm relative overflow-hidden"
          >
            <div
            ...
            <div className="relative">
              <div className="w-12 h-12 rounded-2xl border hover:border-orange-500 shadow-inner flex items-center justify-center mb-6 ">
                {stat.icon}
              </div>
