    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className={`absolute z-9999 min-w-32 overflow-hidden rounded-md border border-border bg-card text-card-foreground p-1 shadow-md dark:shadow-[0_2px_10px_rgba(0,0,0,0.3)] ${positionClasses} ${alignmentClasses} ${className}`}
          role="menu"
